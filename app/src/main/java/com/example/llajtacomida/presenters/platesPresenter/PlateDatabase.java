...
public class PlateDatabase {
    ...
    public PlateDatabase(final Context context, final Plate plate, final byte [] thumb_byte) {
...
//        Configiración de la base de datos
    ...
    public PlateDatabase(Context context, Plate plate){
        this.context = context;
        this.plate = plate;
        databaseReference = FirebaseDatabase
                .getInstance()
        ...
        Task<Uri> uriTask =  uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
            ...
            public Task<Uri> then(@NonNull Task<UploadTask.TaskSnapshot> task) throws Exception {
                if(task.isSuccessful()){
                    PlateDatabase.isSuccess = true;
                    return storageReference.getDownloadUrl();
                }else{
                    PlateDatabase.isSuccess = false;
