...
//    SupportMapFragment supportMapFragment;
        ...
        spTypesOfMaps.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (adapterView.getItemAtPosition(i).equals(getString(R.string.item_normal))) {
                    ...
                    Toast.makeText(GetLocationMapActivity.this, getString(R.string.message_invalid_option), Toast.LENGTH_SHORT).show();
                }
            }
            @Override
    ...
    private void searchAddress(String query) {
        ...
        Toast.makeText(this, getString(R.string.message_searching)+" "+query+"...", Toast.LENGTH_SHORT).show();
        zoom = 6.5F;
...
//            addresses = geocoder.getFromLocationName("Cochabamba: "+query, 1);
        ...
        if(addresses != null){
            ...
            Toast.makeText(this,  getString(R.string.message_reference_not_found), Toast.LENGTH_SHORT).show();
        }
